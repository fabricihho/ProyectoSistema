            ...
            <div class="card-body" style="padding: 0;">
                <div class="table-responsive" style="max-height: 300px; overflow-y: auto;">
                    <table class="table table-sm table-hover" style="margin: 0;">
                        <thead>
                            <tr>
                                <th style="position: sticky; top: 0; background-color: #1B3C84; color: white; z-index: 10; width: 40px; text-align: center;"><input type="checkbox" id="selectAllDocs" checked></th>
                                <th style="position: sticky; top: 0; background-color: #1B3C84; color: white; z-index: 10;">Tipo</th>
                                <th style="position: sticky; top: 0; background-color: #1B3C84; color: white; z-index: 10;">No. Comprobante</th>
                                <th style="position: sticky; top: 0; background-color: #1B3C84; color: white; z-index: 10;">Gestión</th>
                                <th style="position: sticky; top: 0; background-color: #1B3C84; color: white; z-index: 10;">Observaciones</th>
                            </tr>
                        </thead>
                        <tbody>
