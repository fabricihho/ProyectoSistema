            ...
            <form method="POST" action="/login">
                <div class="form-group">
                    ...
                    <input 
                        ...
                        <?= empty($saved_username) ? 'autofocus' : '' ?>
                    >
                </div>
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        <?= (!empty($saved_username) && empty($saved_password)) ? 'autofocus' : '' ?>
                    >
                </div>

                <div class="form-group" style="display: flex; align-items: center; gap: 10px; margin-bottom: 25px;">
                    <input type="checkbox" id="remember" name="remember" style="width: auto; height: 16px; cursor: pointer;" <?= !empty($saved_username) ? 'checked' : '' ?>>
                    <label for="remember" style="margin: 0; font-weight: normal; cursor: pointer; color: #4A5568; font-size: 14px;">Recordar mi usuario</label>
                </div>
